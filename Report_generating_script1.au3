...
;Run("C:\Documents and Settings\operator\Desktop\test1files\setup.exe")
ControlClick("Program Manager", "","[CLASS:SysListView32; INSTANCE:1]", "left", 2, 35, 539)
WinWait("Form1")
WinActivate("Form1")
;select the location
