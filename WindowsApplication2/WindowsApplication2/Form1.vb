Public Class Form1
    ...
    Private Sub ListBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListBox1.SelectedIndexChanged
        ...
        If ListBox1.SelectedIndex = 1 Then
            ...
            file_location = "C:\Users\Jbrisson\Documents\Visual Studio 2015\Projects\WindowsApplication2\WindowsApplication2\bin\Debug\"
        End If
    ...
    Private Sub DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePicker1.ValueChanged
        'when the date is picked, the values are parced, and stored into the variables day_num, month_num, year_num for later use
